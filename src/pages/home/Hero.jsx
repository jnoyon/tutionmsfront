    ...
    <dialog id="focus" className="modal">
      <div className="modal-box">
        ...
        <h2 className="text-center text-2xl font-bold"> <span className="text-accent">ফোকাস</span> ব্যাচ </h2>
                <p className='text-sm text-justify'> যাদের নির্দিষ্ট সাবজেক্টগুলোতে সমস্যা রয়েছে তাদের জন্য এই ব্যাচ সেরা। এই ব্যাচে শিক্ষার্থীরা মূল বিষয়গুলোতে ফোকাস করে প্রস্তুতি নেবে। প্রতিদিন ১ ঘন্টা ক্লাস অনুষ্ঠিত হবে, যেখানে তিনটি গুরুত্বপূর্ণ বিষয় পরীক্ষাভিত্তিকভাবে পড়ানো হবে। </p>
                <div className="grid mt-2 grid-cols-2 gap-2">
                  <div className="text-sm flex items-center gap-2 bg-green-100 rounded-md p-0.5">
                    <CiCalendarDate className="text-lg"></CiCalendarDate>
