    ...
    <div className="bg-gray-50 min-h-screen p-4 sm:p-6 flex flex-col gap-6">
      ...
      <div className="bg-white shadow-md rounded-lg p-4 text-center">
        <h2 className="text-gray-700 font-medium text-base sm:text-lg md:text-xl">
          আপনি বর্তমানে{" "}
          <span className="font-bold text-primary">ফোকাস ব্যাচ</span> এ
          আছেন। <br />
      ...
      <div className="bg-white shadow-md rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="font-bold text-gray-700">ইন্টেন্সিভ</p>
            <span className="text-sm text-gray-600"> ব্যাচ সম্পর্কে জানুন </span>
          </Link>
