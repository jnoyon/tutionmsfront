  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-md p-4 space-y-4">
      ...
      <h2 className="text-gray-700 font-medium text-center">
        আপনি বর্তমানে <span className="font-bold text-accent">ফোকাস ব্যাচ</span> এ আছেন। ফোকাস ব্যাচ সম্পর্কে জানতে <Link className='text-error font-bold' to='/focus'> এখানে ক্লিক করুন </Link>
      </h2>
